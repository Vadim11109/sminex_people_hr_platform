    ...
    grades: [
      {
        ...
        ranks: [
          { rank: 1, score: '1.67 – 1.99', salary: '145 000 – 175 000', desc: 'Уверенно управляет бэклогом, взаимодействует с командой разработки. Начинает работать с метриками и данными. Готов к росту до Middle.' },
          ...
          { rank: 3, score: '1.00 – 1.33', salary: '90 000 – 115 000', desc: 'Входит в профессию. Работает строго по задачам в рамках одной фичи под руководством ментора. Изучает процессы, инструменты и продуктовый подход компании.' },
        ],
      },
      {
        ...
        ranks: [
          { rank: 1, score: '2.67 – 2.99', salary: '275 000 – 340 000', desc: 'Высокий уровень самостоятельности. Ведёт сложные продукты с ощутимым влиянием на бизнес. Лидирует кросс-функциональные инициативы, предлагает системные решения.' },
          ...
          { rank: 3, score: '2.00 – 2.33', salary: '175 000 – 220 000', desc: 'Самостоятельно ведёт один продукт или стрим. Приоритизирует бэклог на основе данных, взаимодействует со стейкхолдерами, выстраивает коммуникацию с командой.' },
        ],
      },
      {
        ...
        ranks: [
          { rank: 1, score: '3.67 – 4.00', salary: 'от 510 000',        desc: 'Топ-уровень. Формирует культуру продуктовой разработки в компании. Принимает ключевые продуктовые решения, задаёт планку качества для всей команды.' },
          ...
          { rank: 3, score: '3.00 – 3.33', salary: '340 000 – 420 000', desc: 'Формирует продуктовое видение на уровне направления. Влияет на стратегию компании. Развивает команду, создаёт процессы и стандарты работы.' },
        ],
      },
    ],
  },
